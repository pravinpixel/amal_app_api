    ...
    <div id="kt_app_content_container" class="app-container container">
     <div class="card">
      <div class="card-header border-0 pt-6">
         ...
         <input type="text" id="searchInput" class="form-control form-control-solid w-350px ps-15" placeholder="Search Testimonial" />
        </div>
       </div>
       <div class="card-toolbar" style="gap: 25px">
             ...
             <div>
                ...
                href="{{url('testimonial/create')}}">Create New</a>      
            </div>
        </div>
        </div>
           @include('testimonial.filter')        
            ...
            <table style="width:100%;" class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
              <thead style="color: #3498db">
                          <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0" style="color:#3498db !important">
                              ...
                              <th class="min-w-125px">Customer Age</th>
                              <th class="min-w-125px">State</th>
                              <th class="min-w-125px">Language</th>
                              <th class="min-w-125px">Insurance Type</th>
                              <th class="min-w-175px">Testimonial category</th>
                          ...
                          <tbody class="fw-semibold text-gray-600">
                              ...
                              <tr>
                                  ...
                                  <td>{{$testimonial->insurance_type}}</td>
                                  <td>{{$testimonial->testimonial_category}}</td>
                                  ...
                                  <td class="td" style="text-align: center">
                                            <a href="{{route('testimonial.view', $testimonial->id)}}" class="btn btn-icon btn-active-primary btn-light-primary mx-1 w-30px h-30px ">
                                                <i class="fa fa-eye"></i>
                                            </a>
                                            <a href="{{route('testimonial.edit', $testimonial->id)}}" class="btn btn-icon btn-active-primary btn-light-primary mx-1 w-30px h-30px ">
                                                    <i class="fa fa-edit"></i>
                                             </a>
                                            <button type="button" class="btn btn-icon btn-active-danger btn-light-danger mx-1 w-30px h-30px deletetestimonialBtn"
